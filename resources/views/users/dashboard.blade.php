                    ...
                    <div class="card card-layout-frame">
                        <div class="card-body">
                            <div class="flex items-center gap-4 justify-between">
                                ...
                                <a href="{{route('inspections.list','open')}}"
                    ...
                    <div class="card card-layout-frame">
                        <div class="card-body">
                            <div class="flex items-center gap-4 justify-between">
                                ...
                                <a href="{{route('inspections.list','open')}}" class="btn bg-rose-50 hover:bg-rose-100 active:bg-rose-200 text-rose-600 btn-sm">مشاهده</a>
                            </div>
                        </div>
                    </div>
                </div>
