                            ...
                            <div class="grid grid-cols-4 md:grid-cols-4 gap-4 mt-5">
                                ...
                                <div class="col-span-1">
                                    <div class="form-item vertical">
                                        ...
                                        <input class="input" type="text" disabled
                                               value="{{$inspection->inspectorr->fullName()}}">
                                    </div>
                                </div>
                                <div class="col-span-1">
                                    <div class="form-item vertical">
                                        <label class="form-label mb-2">{{__('inspection end date')}}</label>
                                        <input type="text" class="input" disabled value="{{$inspection->end_date?jdate_from_gregorian($inspection->end_date,'%Y/%m/%d - H:i'):'-'}}">
                                    </div>
                                </div>
                                <div class="col-span-1">
                                    <div class="form-item vertical">
                                        <label class="form-label mb-2">{{__('next inspection date')}}</label>
                                        <input type="text" class="input" disabled value="{{$inspection->next_inspection_date?jdate_from_gregorian($inspection->next_inspection_date,'%Y/%m/%d - H:i'):'-'}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                @foreach($inspection->files as $file)
                                    <div class="col-span-1">
                                        <div class="input-group mb-4 vertical">
                                            ...
                                            <a href="{{ route('inspector.download', \Illuminate\Support\Str::replace('inspection_files/','',$file->file_path)) }}"
