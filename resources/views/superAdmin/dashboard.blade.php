                            ...
                            <div class="flex items-center gap-4 justify-between">
                                <span
														...
														<span class="avatar-icon">
															<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                                 fill="currentColor" aria-hidden="true" height="1em" width="1em">
                                ...
                                <div>
                                    <div class="flex gap-1.5 items-end mb-2">
                                        <p class="font-bold leading-none">تعداد کاربران</p>
                                    </div>
                                    <p class="flex items-center gap-1">
                                        <span class="font-semibold">{{$users}} نفر </span>
                                    </p>
                                </div>
                                <a href="{{route('super-admin.users.list','other')}}" class="btn bg-sky-50 hover:bg-sky-100 text-sky-600 btn-sm">مشاهده</a>
                            </div>
                        </div>
                    </div>
                    <div class="card card-layout-frame">
